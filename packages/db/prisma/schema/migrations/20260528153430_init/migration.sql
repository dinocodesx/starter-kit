...
-- CreateIndex
CREATE UNIQUE INDEX "email_delivery_deliveryKey_key" ON "email_delivery"("deliveryKey");

-- CreateIndex
CREATE UNIQUE INDEX "email_delivery_providerMessageId_key" ON "email_delivery"("providerMessageId");
